...
:: 使用方法 : set_plug_power_9258 [オプション] <power> <ip_address> [port] [user] [password] 
::  -h, --help 使用方法を表示します 
:: <power>      : プラグのON/OFF 
:: <ip_address> : IP Power 9258T+Ping のIPアドレス 
:: [port]       : (オプション) IP Power 9258T+Ping のポート (デフォルト: "80") 
:: [user]       : (オプション) IP Power 9258T+Ping のログインユーザー名 (デフォルト: "admin") 
:: [password]   : (オプション) IP Power 9258T+Ping のログインパスワード (デフォルト: "12345678") 
...
if not %errorlevel%==0 (
    echo IP Power の IPアドレスが間違っています 
    exit /b 1
)
...
echo ^<ip_address^> : IP Power 9258T+Ping のIPアドレス 
echo [port]       : (オプション) IP Power 9258T+Ping のポート (デフォルト: "80") 
echo [user]       : (オプション) IP Power 9258T+Ping のログインユーザー名 (デフォルト: "admin") 
echo [password]   : (オプション) IP Power 9258T+Ping のログインパスワード (デフォルト: "12345678") 
exit /b